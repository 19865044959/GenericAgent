...
QWEN_API_KEY = 'sk-ws-H.RPMPLMD.FY3I.MEUCIQCXNVZDVvbNJx_tiBa6aaRnLJCS3MSNU3-ybXjefAxifAIgNg8SFQMDdwrXWG1lebKAxIhy811eegZAv0wQoFLupmY'
QWEN_API_BASE = 'https://dashscope.aliyuncs.com/compatible-mode'
QWEN_MODEL = 'qwen3-vl-plus'
DEFAULT_BACKEND = 'qwen'               # 默认后端: 'claude' / 'openai' / 'modelscope' / 'qwen'
# =================================================================
...
def ask_vision(image_input, prompt="详细描述这张图片的内容", timeout=60, max_pixels=1440000, backend=DEFAULT_BACKEND):
    ...
    try:
        if backend == 'claude':
            ...
            return _call_openai_compat(
                b64, prompt, timeout,
                apibase=QWEN_API_BASE, apikey=QWEN_API_KEY, model=QWEN_MODEL, proxy=None
            )
        else: return f"Error: 未知backend '{backend}'，可选: claude, openai, modelscope, qwen"
